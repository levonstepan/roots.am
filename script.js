...
const translations = {
  ...
  hy: {
    ...
    classCards: [
      ...
      {
        title: "Պրեմիում",
        subtitle: "Մշակված • Մանրակրկիտ • Արտահայտիչ",
        items: [
          "Բարձրորակ, խնամքով ընտրված փայտ",
          "Մշակման առաջադեմ տեխնիկաներ",
          "Մանրուքների և միացումների հանդեպ մեծ ուշադրություն",
          "Ավելի կոմպլեքս ֆորմաներ և էսթետիկա",
          "Բարելավված տեսողական և շոշափելի փորձառություն",
    ...
    customiseLead:
      "Ձեր ընտրությունը մեզ համար կարևոր է։ Այն հասնում է արհեստանոց` դառնալու կահույք ՝ ստեղծված հենց ձեզ համար։",
    scrollHint: "",
    customiseCardTitle: "Ստեղծեք ձեր տարբերակը",
    customiseCardBody: "Մենք կհաստատենք արտադրության ժամանակացույցը, նյութերի առկայությունն ու արժեքները, նախքան արտադրությունը սկսելը։ Ընտրեք․",
